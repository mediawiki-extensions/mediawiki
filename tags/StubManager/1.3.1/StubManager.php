 ...
 * @package StubManager
 * @version 1.3.1
 * @Id $Id: StubManager.php 1027 2008-04-22 17:01:23Z jeanlou.dupont $
 */
//<source lang=php>
class StubManager {
	...
	const thisVersion = '$Id: StubManager.php 1027 2008-04-22 17:01:23Z jeanlou.dupont $';
	...
	static function getRevisionId( $svnId=null ) {
		...
		// e.g. $Id: StubManager.php 1027 2008-04-22 17:01:23Z jeanlou.dupont $
		$data = explode( ' ', $svnId );
		return $data[2];
	}
	/**
