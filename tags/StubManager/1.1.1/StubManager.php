 ...
 * @package StubManager
 * @version 1.1.1
 * @Id $Id: StubManager.php 854 2008-01-06 05:11:40Z jeanlou.dupont $
 */
//<source lang=php>
...
class StubManager
{
	...
	const thisVersion = '$Id: StubManager.php 854 2008-01-06 05:11:40Z jeanlou.dupont $';
	static $logTable;
...
#		$wgExtensionFunctions[] = __CLASS__.'::setup'; // PHP <v5.2.2 issues a warning on this one.
	...
	{	
		...
		// e.g. $Id: StubManager.php 854 2008-01-06 05:11:40Z jeanlou.dupont $
		$data = explode( ' ', $svnId );
		return $data[2];
	}
	/**
