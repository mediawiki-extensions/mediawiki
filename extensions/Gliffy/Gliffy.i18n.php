...
MW_Gliffy::getInstance('MW_Gliffy')->setMessages(
	array( 'en' => 
		array(
			...
			'gliffy-example'		=> '<br/><html><div class="error-example"><script src="http://www.gliffy.com/diagramEmbed.js" type="text/javascript"> </script><script type="text/javascript"> gliffy_did = "1422053"; embedGliffy(); </script></div></html>', 
