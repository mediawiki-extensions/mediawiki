...
*/
# Begin modification
// Again, if the user is asking for a "save" title, then don't
// bother with "edit" rights. 
		if ( !$new && !$this->save )
		{
			if ( !$this->mTitle->userCanEdit() )
			{
...
// <jld>
		...
		// Make sure that the user has 'edit' rights
		// to apply changes to an existing title.
		if (!$new)
		{
