 ...
 * @package StubManager
 * @version 1.2.1
 * @Id $Id: StubManager.php 900 2008-01-14 15:39:29Z jeanlou.dupont $
 */
//<source lang=php>
...
class StubManager
{
	...
	const thisVersion = '$Id: StubManager.php 900 2008-01-14 15:39:29Z jeanlou.dupont $';
	static $logTable;
...
#		$wgExtensionFunctions[] = __CLASS__.'::setup'; // PHP <v5.2.2 issues a warning on this one.
	...
	{	
		...
		// e.g. $Id: StubManager.php 900 2008-01-14 15:39:29Z jeanlou.dupont $
		$data = explode( ' ', $svnId );
		return $data[2];
	}
	/**
