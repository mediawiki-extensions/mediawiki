...
# <jld id="6">
# <file name="SpecialRecentChanges.php" />
# <func name="wfSpecialRecentchanges" />
# Filter function that respects user rights.
# 
			// Get the namespace of the title
			$ns=$obj->rc_namespace;
			// Check if the user is allowed browsing through this namepsace
			if (! $wgUser->isAllowedEx( $ns,"~","browse") ) continue;			
			#if ( ! hnpClass::userCanX($ns,"~","browse") )	continue;
# </jld>
