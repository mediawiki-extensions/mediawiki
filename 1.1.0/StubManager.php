 ...
 * @package StubManager
 * @version 1.1.0
 * @Id $Id: StubManager.php 736 2007-12-10 15:30:44Z jeanlou.dupont $
 */
//<source lang=php>
...
class StubManager
{
	...
	const thisVersion = '$Id: StubManager.php 736 2007-12-10 15:30:44Z jeanlou.dupont $';
	static $logTable;
...
#		$wgExtensionFunctions[] = __CLASS__.'::setup'; // PHP <v5.2.2 issues a warning on this one.
	...
	{	
		...
		// e.g. $Id: StubManager.php 736 2007-12-10 15:30:44Z jeanlou.dupont $
		$data = explode( ' ', $svnId );
		return $data[2];
	}
	/**
